...
//@Profile(value = "PRO")
//@Profile去配置文件找spring.profiles.active，匹配则可执行注解下的方法，否则不可以
...
public class ScheduleTest {
    ...
    @Value("${SCHEDULED_TEXT}")
    private String scheduled_text;

    @Scheduled(cron = "* * * 31 1 ?")
    public void runScheduledTask(){
        log.info(scheduled_text);
    }

    @Scheduled(cron = "* 14 13 14 2 ?")
    public void runBambooTask(){

        log.info("runBambooTask");
